...
argumento; hecho eso, debe guardar el argumento junto con el resultado de la invocación 
...
function cacheFunction(cb) {
  let cache={};
  return function (arg) {
    // La invocacion del callback pasandole el arg que recibe la function nos 
    // da un valor, este valor pertenece a una propiedad
...
let getNombreInstructor = getNombre.bind(instructor); // enlaza una funcion con un objeto
